...
import 'package:hale_movil/src/pages/home_page/home_page.dart';
import 'package:hale_movil/src/pages/login_page/login_page.dart';
import 'package:hale_movil/src/pages/my_offers_page/my_offers_page.dart';
import 'package:hale_movil/src/pages/my_services_page/my_services_page.dart';
import 'package:hale_movil/src/pages/notification_page/notification_page.dart';
import 'package:hale_movil/src/pages/payment_page/payment_page.dart';
import 'package:hale_movil/src/pages/recovery_password_page/recovery_password_page.dart';
import 'package:hale_movil/src/pages/register_page/register_page.dart';
import 'package:hale_movil/src/pages/reset_password_page/reset_password_page.dart';
import 'package:hale_movil/src/pages/search_offers_page/search_offers_page.dart';
import 'package:hale_movil/src/pages/search_workers_page/search_workers_page.dart';
import 'package:hale_movil/src/pages/splash_page/splash_page.dart';
...
import 'package:hale_movil/src/pages/validate_account_page/validate_account_page.dart';
import 'package:hale_movil/src/pages/welcome_page/welcome_page.dart';
